...
- 🔧 **Advanced equipment system** - Manage rigs, canopies, and linesets separately
- ⚙️ **Equipment combinations** - Combine components into complete setups
- 📊 **Component-level statistics** - Track usage by rig, canopy, and lineset
- 💫 **Equipment archiving** - Archive old combinations while preserving statistics
...
2. **Set up equipment components**: 
   - Go to Equipment tab → Rigs to add your rig(s) (e.g., Javelin, Mutant)
   - Go to Canopies to add your canopies (e.g., Petra64, Petra68)
   - Go to Linesets to add your linesets (e.g., #1, #2, #3)
3. **Create equipment combinations**:
   - Go to Combinations to combine your components into complete setups
   - Name each combination (e.g., "Main Setup", "Backup Rig")
4. **Log jumps**: Return to Jumps tab and select from your equipment combinations
...
### **Components**
- **Rigs**: Your harness/container systems (e.g., Javelin Odyssey, Mutant)
- **Canopies**: Your parachutes (e.g., Petra64, Petra68, Sabre2 120)  
- **Linesets**: Your line sets, numbered or named (e.g., #1, #2, #3, A-lines)

### **Combinations**
- Combine any rig + canopy + lineset into a complete equipment setup
- Name your combinations (e.g., "Primary Setup", "Backup Rig", "Student Gear")
- Use these combinations when logging jumps

### **Archiving**
- Archive old equipment combinations when you stop using them
- Archived equipment won't appear in the jump logging dropdown
- All statistics are preserved for archived equipment

### **Statistics**
- **Equipment Combinations**: See usage for each complete setup
- **Component Level**: Track individual rig, canopy, and lineset usage
